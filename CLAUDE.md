...
├── mcp_server/                  # FastMCP: 31 tools + 3 resources
...
| `mcp_server/` | Done | 31 tools + 3 resources (includes AI workouts, training log, ramp tests, activity details, workout cards) |
