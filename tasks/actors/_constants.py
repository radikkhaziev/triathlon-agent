...
# The wellness pipeline defers the compose by this much so Intervals.icu can settle
...
# the docstrings on ``_is_free_for_morning_report`` / ``_dispatch_morning_report_if_ready``.
