...
def register_resources(mcp: FastMCP) -> None:
    ...
    def thresholds() -> str:
        ...
        return (
            ...
            "\n"
            "HRV Algorithm: Flatt & Esco — 3-day-smoothed RMSSD vs 7-day baseline,\n"
            "  asymmetric bounds (-1/+0.5 SD). The baseline window is shifted by the\n"
            "  smoothing length so today's noise doesn't leak into the comparator.\n"
            "  rmssd_today_smoothed is the value actually classified; raw rmssd_7d\n"
            "  is recency-inclusive and may differ.\n"
            "\n"
            "RHR: inverted — elevated RHR = red, low RHR = green\n"
            "  3-day-smoothed RHR vs 30-day baseline (also shifted), ±0.5 SD.\n"
            "  rhr_today_smoothed is the value compared against bounds;\n"
            "  rhr_today is the raw last reading.\n"
            "\n"
