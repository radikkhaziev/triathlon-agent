...
- **Watchdog в MVP или Phase 2?** Dramatiq retry (max_retries=3) покрывает transient cases. Stuck state после max_retries — редкий edge-case; юзер может retry вручную. Склоняюсь к Phase 2.
