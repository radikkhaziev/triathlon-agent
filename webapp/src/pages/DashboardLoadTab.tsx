...
//
// Layout (top → bottom):
//   1. Sport segmented control (bike / run / swim, local state).
//   2. Swim-only period filter (1m/3m/6m/1y).
//   3. bike/run: Decoupling · Zone Distribution · BikeReadiness / Marathon
//      Shape · EF trend · Cardiac Drift · recent sessions.
//   4. swim: Pace trend · SWOLF trend · recent swims.
//
// Endurance Score lives on Wellness home (direction-b-halo.jsx:666-677); the
// card/detail no longer ship from this tab.
//
